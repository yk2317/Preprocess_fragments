    ...
    with open(input_file, 'r') as f:
        for line in f:
            ...
            if "N" not in motif:
                ...
                processed_line = [chr, str(start), str(end), name, gc_content, motif, strand, str(length), pos, ref, alt, dist_start, dist_end, clipped, mapq, mbq, consensus_min_depth, consensus_error_rate]
