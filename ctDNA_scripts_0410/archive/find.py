...
def find_substitution(bam_file, out_dir, chromosome, position, ref_base, alt_base):
    ...
    with open(vcf_file, 'r') as vcf:
        for line in vcf:
            ...
            if parts[7] == sample_id:  # Adjust this index based on where the sample ID is found
                ...
                ref_base = parts[3]
                alt_base = parts[4]
                find_substitution(bam_file_path, out_dir, chromosome, position, ref_base, alt_base)
