...
def count_8mer(directory_path, output_name, strand_info):
    nucleotides = ['A', 'C', 'G', 'T']
    ...
    for txt_file in txt_files:
        if (strand_info == "pos" and "pos" in txt_file) or (strand_info == "neg" and "neg" in txt_file):
...
if __name__ == "__main__":
    ...
    strand_info = sys.argv[3] 
    count_8mer(directory_path, output_name, strand_info)
